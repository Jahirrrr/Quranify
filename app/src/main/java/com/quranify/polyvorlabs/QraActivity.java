...
public class QraActivity extends AppCompatActivity {
	...
	private ArrayList<HashMap<String, Object>> English = new ArrayList<>();
	...
	private void initializeLogic() {
		...
		if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
			Window w =QraActivity.this.getWindow();
		...
		if (!sorah.isEmpty()) {
			setTitle("Surah".concat(sorah.get("transliteration").toString()));
	...
	public void _dark() {
		...
		linear5.setBackgroundColor(0xFFFAFAFA);
